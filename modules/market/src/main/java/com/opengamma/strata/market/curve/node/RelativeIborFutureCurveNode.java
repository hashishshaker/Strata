...
/**
 * A curve node whose instrument is an Ibor Future specified relatively.
 * <p>
 ...
 */
@BeanDefinition
public final class RelativeIborFutureCurveNode
   ...
   */
  public static RelativeIborFutureCurveNode of(IborFutureTemplate template, QuoteId rateId) {
   ...
   * @return a node whose instrument is built from the template using a market rate
   */
  public static RelativeIborFutureCurveNode of(
  ...
  public static RelativeIborFutureCurveNode of(
    ...
    return new RelativeIborFutureCurveNode(template, rateId, additionalSpread, label, CurveNodeDate.END);
  }
   ...
   */
  public RelativeIborFutureCurveNode withDate(CurveNodeDate date) {
    return new RelativeIborFutureCurveNode(template, rateId, additionalSpread, label, date);
  }

  //------------------------- AUTOGENERATED START -------------------------
  ///CLOVER:OFF
  /**
   * The meta-bean for {@code RelativeIborFutureCurveNode}.
   * @return the meta-bean, not null
   */
  public static RelativeIborFutureCurveNode.Meta meta() {
    return RelativeIborFutureCurveNode.Meta.INSTANCE;
  }

  static {
    JodaBeanUtils.registerMetaBean(RelativeIborFutureCurveNode.Meta.INSTANCE);
  }
   ...
   */
  public static RelativeIborFutureCurveNode.Builder builder() {
    return new RelativeIborFutureCurveNode.Builder();
  }

  private RelativeIborFutureCurveNode(
      IborFutureTemplate template,
      QuoteId rateId,
      double additionalSpread,
      String label,
  ...
  @Override
  public RelativeIborFutureCurveNode.Meta metaBean() {
    return RelativeIborFutureCurveNode.Meta.INSTANCE;
  }
  ...
  public boolean equals(Object obj) {
    ...
    if (obj != null && obj.getClass() == this.getClass()) {
      RelativeIborFutureCurveNode other = (RelativeIborFutureCurveNode) obj;
  ...
  public String toString() {
    ...
    buf.append("RelativeIborFutureCurveNode{");
  ...
  public static final class Meta extends DirectMetaBean {
    ...
    private final MetaProperty<IborFutureTemplate> template = DirectMetaProperty.ofImmutable(
        this, "template", RelativeIborFutureCurveNode.class, IborFutureTemplate.class);
    /**
     * The meta-property for the {@code rateId} property.
     */
    private final MetaProperty<QuoteId> rateId = DirectMetaProperty.ofImmutable(
        this, "rateId", RelativeIborFutureCurveNode.class, QuoteId.class);
    /**
    ...
    private final MetaProperty<Double> additionalSpread = DirectMetaProperty.ofImmutable(
        this, "additionalSpread", RelativeIborFutureCurveNode.class, Double.TYPE);
    /**
     * The meta-property for the {@code label} property.
     */
    private final MetaProperty<String> label = DirectMetaProperty.ofImmutable(
        this, "label", RelativeIborFutureCurveNode.class, String.class);
    /**
     * The meta-property for the {@code date} property.
     */
    private final MetaProperty<CurveNodeDate> date = DirectMetaProperty.ofImmutable(
        this, "date", RelativeIborFutureCurveNode.class, CurveNodeDate.class);
    /**
     * The meta-properties.
     */
    ...
    @Override
    public RelativeIborFutureCurveNode.Builder builder() {
      return new RelativeIborFutureCurveNode.Builder();
    }

    @Override
    public Class<? extends RelativeIborFutureCurveNode> beanType() {
      return RelativeIborFutureCurveNode.class;
    }
    ...
    protected Object propertyGet(Bean bean, String propertyName, boolean quiet) {
      switch (propertyName.hashCode()) {
        case -1321546630:  // template
          return ((RelativeIborFutureCurveNode) bean).getTemplate();
        case -938107365:  // rateId
          return ((RelativeIborFutureCurveNode) bean).getRateId();
        case 291232890:  // additionalSpread
          return ((RelativeIborFutureCurveNode) bean).getAdditionalSpread();
        case 102727412:  // label
          return ((RelativeIborFutureCurveNode) bean).getLabel();
        case 3076014:  // date
          return ((RelativeIborFutureCurveNode) bean).getDate();
      }
  ...
  //-----------------------------------------------------------------------
  /**
   * The bean-builder for {@code RelativeIborFutureCurveNode}.
   */
  public static final class Builder extends DirectFieldsBeanBuilder<RelativeIborFutureCurveNode> {
     ...
     */
    private Builder(RelativeIborFutureCurveNode beanToCopy) {
    ...
    @Override
    public RelativeIborFutureCurveNode build() {
      return new RelativeIborFutureCurveNode(
          template,
          rateId,
          additionalSpread,
          label,
    ...
    public String toString() {
      StringBuilder buf = new StringBuilder(192);
      buf.append("RelativeIborFutureCurveNode.Builder{");
