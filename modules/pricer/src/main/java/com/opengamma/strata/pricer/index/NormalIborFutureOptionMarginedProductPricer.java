...
public class NormalIborFutureOptionMarginedProductPricer extends IborFutureOptionMarginedProductPricer {
  ...
  public double price(
    ...
    double expiry = volatilities.relativeTime(futureOption.getExpiry());
    double strike = futureOption.getStrikePrice();
    ResolvedIborFuture future = futureOption.getUnderlyingFuture();
    double volatility = volatilities.volatility(expiry, future.getLastTradeDate(), strike, futurePrice);

    return NormalFormulaRepository.price(futurePrice, strike, expiry, volatility, futureOption.getPutCall());
  }
  ...
  public double deltaStickyStrike(
    ...
    return NormalFormulaRepository.delta(futurePrice, strike, expiry, volatility, futureOption.getPutCall());
  }
  ...
  public IborFutureOptionSensitivity priceSensitivityNormalVolatility(
    ...
    double vega = NormalFormulaRepository.vega(futurePrice, strike, expiry, volatility, futureOption.getPutCall());
    return IborFutureOptionSensitivity.of(
        future.getIndex(), expiry, future.getLastTradeDate(), strike, futurePrice, vega);
  }
